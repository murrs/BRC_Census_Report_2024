...
### Addressing sustainability personally
...
sustainabilityAddress <- makePlotData("How did you (and your camp or project, if applicable) begin to address sustainability in Black Rock City?",
                                      ...
                                      years = 2022:2024,
                                      levels = c(as.list(rep(TRUE, times = 3))),
                                      labels = c("I calculated my carbon footprint \n before arrival in Black Rock City",
...
```{r}
RIDE <- makePlotData("How did you see Radical Inclusion, Diversity, and Equity (R.I.D.E.) in action while in BRC in 2024?",
                     varNameTable = varNameTable,
                     designs = list(design22, design23, design24),
