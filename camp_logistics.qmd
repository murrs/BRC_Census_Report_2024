...
#                                   rep(list(c("Yes","Don\'t know", "No")), times = 2)),
...
# 
# 
# # ggplot(generate[generate$year == 2023,], aes(x = labels, y = est)) +
...
#                                                        census23$weights)))
# vehicleHoursMean$year <- c(2016:2019, 2022:2023)
# 
# 
...
#                                                        census23$weights)))
# campHoursMean$year <- c(2016:2019, 2022:2023)
# 
# 
...
# 
# ggplot(genOutput[genOutput$year == 2023,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B", color = "#EA008B",
#            alpha = 0.7) +
#   scale_y_continuous(labels = percent) +
