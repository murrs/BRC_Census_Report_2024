...
<!-- religion2 <- makePlotData("Do you belong to a religion or religious denomination?", -->
...
<!--                          levels = as.list(rep(c("Buddhist", "Catholic", -->
...
#                            designs = list(design22, design23),
#                            years = 2022:2023,
#                            levels = as.list(rep(TRUE, times = 2)),
...
# 
# ggplot(disability[-c(9, 19),], aes(x = labels, y = est, fill = as.factor(year))) +
#   geom_bar(stat = "identity", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   scale_fill_manual(values = discreteColors[2:1]) +
#   labs(x = "Disability", y = "Burning Man participants (%)",
#        title = "What disability statuses (if any) do you identify with?",
#        fill = "") +
#   theme_bw() +
#   theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1))
# 
# 
# makeTableData(disability[-c(9, 19),]) |>
...
# 
# ggplot(romanticOrientation[romanticOrientation$year == 2023,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Romatic orientation", y = "Burning Man participants in 2023 (%)",
#        title = "Which of these expressions best describes \n your romantic orientation?") +
#   theme_bw() +
#   coord_flip()
# 
...
```{r}
# relationship <- makePlotData("Some people use specific labels to describe their relationship style. Do you consider one or more of these labels to describe your relationships?",
#                            varNameTable = varNameTable,
#                            designs = list(design22, design23),
#                            years = c(2022:2023),
#                            levels = as.list(rep(TRUE, times = 2)),
...
#                                       "Relationship anarchist",
#                                       "Other"),
#                           labelOrder = c(15,7,8,9,4,11,13,5,10,14,12,6,3,2,1))
# 
# ggplot(relationship, aes(x = labels, y = est, fill = as.factor(year))) +
#   geom_bar(stat = "identity", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   scale_fill_manual(values = discreteColors[2:1]) +
#   labs(x = "Relationship label", y = "Burning Man participants (%)",
#        title = "Some people use specific labels to describe their \n relationship style. Do you consider one or more of \n these labels to describe your relationships?",
#        fill = "") +
#   theme_bw() +
#   coord_flip() +
