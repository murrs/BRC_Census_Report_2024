...
ggplot(returnBRC, aes(x = labels, y = est)) +
  ...
  labs(x = "Plan to return to BRC", y = "Burning Man participants in 2024 (%)",
       title = "Do you plan to return to Black Rock City for Burning Man?") +
  theme_bw() +
  coord_flip()
...
tdrn[4] <- "Middle Eastern or North African <sup>a</sup>"
tdrn[7] <- "Native Hawaiian or Pacific Islander <sup>b</sup>"
tdrn[8] <- "Other <sup>c</sup>"
rownames(tableDat) <- tdrn

tdcn <- colnames(tableDat)

tdcn[colnames(tableDat)=="2022"] <- "2022 <sup>d</sup>"
