...
# 
# ggplot(regionalInvolve[regionalInvolve$year == 2023,], aes(x = labels, y = est)) +
...
#                                             3, 2, 12, 11, 14)))
# 
# ggplot(valuableInfo[valuableInfo$year == 2023,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
#   labs(x = "Information type", y = "Burning Man participants in 2023 (%)",
...
#                                    year = as.factor(c(2023, 2022, 2019, 2018)))
# 
...
#                                                   x[3], ")")})
# 
# tableDat <- data.frame(y2018 = q2018, y2019 = q2019, y2022 = q2022, y2023 = q2023)
# rownames(tableDat) <- c("10^th^ percentile", "25^th^ percentile",
#                         "Median", "75^th^ percentile", "90^th^ percentile",
#                         "99^th^ percentile")
# kbl(tableDat, col.names = c(2018:2019, 2022:2023), row.names = TRUE) |>
#   kable_paper("striped", full_width = F) |>
...
# 
# ggplot(skillsInspire[skillsInspire$year == 2023,], aes(x = labels, y = est)) +
#   geom_bar(stat = "identity", fill = "#EA008B") +
#   scale_y_continuous(labels = percent) +
...
```{r}
# skillsUseful <- makePlotData("Have any of these skills proved useful in the default world (away from Black Rock City)?",
#                               varNameTable = varNameTable,
#                               designs = list(design16, design17, design18,
#                                              design19, design22, design23),
#                               years = c(2016:2019, 2022:2023),
...
#        title = "Have any of these skills proved useful in the default world?")
# 
...
#   geom_bar(stat = "identity", position = "dodge") +
#   scale_y_continuous(labels = percent) +
#   scale_x_continuous(breaks = c(2017:2019, 2022:2023), labels = c(2017:2019, 2022:2023)) +
#   labs(x = "Non-profit or charity", 
#        y = "Burning Man participants (%)", fill = "Year",
#        title = "How are you using these skills outside of Black Rock City?") +
#   theme_bw() +
#   theme(panel.grid.minor = element_blank()) +
#   scale_fill_manual(values = discreteColors[1:5])
# 
# makeTableData(skillsOutside) |>
#   kbl(col.names = c(2017:2019, 2022:2023), row.names = TRUE) |>
#   kable_paper("striped", full_width = F) |>
...
#                              varNameTable = varNameTable,
#                              designs = list(design18, design19, design22, design23),
...
#   kbl(col.names = c(2018:2019, 2022:2023), row.names = TRUE) |>
#   kable_paper("striped", full_width = F) |>
#   column_spec(column = 1:5, width_min = "10.5em") |>
#   kable_styling() |>
#   scroll_box(width = "100%")
